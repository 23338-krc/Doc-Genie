...
Original file is located at
    https://colab.research.google.com/#fileId=https%3A//huggingface.co/ibm-granite/Doc-Genie.ipynb
"""

!pip install -U transformers

"""## Local Inference on GPU
Model page: https://huggingface.co/ibm-granite/Doc-Genie

⚠️ If the generated code snippets do not work, please open an issue on either the [model repo](https://huggingface.co/ibm-granite/Doc-Genie)
...
pipe = pipeline("text-generation", model="ibm-granite/Doc-Genie")
messages = [
...
tokenizer = AutoTokenizer.from_pretrained("ibm-granite/Doc-Genie")
model = AutoModelForCausalLM.from_pretrained("ibm-granite/Doc-Genie")
messages = [
    {"role": "user", "content": "Who are you?"},
]
